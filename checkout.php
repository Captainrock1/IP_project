<?php
    ...
    define('OMISE_PUBLIC_KEY', 'pkey_test_5re7tj95xci8nzm4wvc');
    define('OMISE_SECRET_KEY', 'skey_test_5re6rrinhichrdsi5kw');
    ...
    $bill_status = ($charge['status']);
    $bill_realtotal = $bill_total/100;

    if($bill_status='successful'){
      $booking_status = "UPDATE booking SET booking_status = 1 WHERE book_id = '$book_id'";
      $add_bill = "INSERT INTO bill (book_id, bill_status, bill_total) VALUES ('$book_id', '$bill_status', '$bill_realtotal');";
      
      if (mysqli_query($db, $add_bill)) {  
      }
      if(mysqli_query($db, $booking_status)){
